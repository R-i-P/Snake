...
function bot() {
    ...
    // Calculate the distances to the food in each direction
    ...
    // if (upDist < downDist && upDist < leftDist && upDist < rightDist && direction !== "down") {
    //   direction = "up";
    // } else if (downDist < upDist && downDist < leftDist && downDist < rightDist && direction !== "up") {
    //   direction = "down";
    // } else if (leftDist < upDist && leftDist < downDist && leftDist < rightDist && direction !== "right") {
    //   direction = "left";
    // } else if (rightDist < upDist && rightDist < downDist && rightDist < leftDist && direction !== "left") {
    //   direction = "right";
    // }
    if (upDist < downDist && upDist < leftDist && upDist < rightDist && direction !== "down") {
        direction = "up";
